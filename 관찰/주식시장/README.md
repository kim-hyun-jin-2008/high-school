...
* 매수
  - 부동산은 나라마다 다르겠지만 지속적인 인플레이션이 있다면 빨리 사는게 좋고 어느지역을 살지 고민 하면 된다.
  - **주식은 사고 기다리는것이 아니다.(X) 기다렸다가 사는것이다.(O)**
...
## 돈으로 투표를 하는 시장
* 표(돈)를 많이 받은 종목이 올라가게 된다.
  - 보통 미인대회라고 표현을 하기도 하지만 더 정확하게는 표(돈)을 많이 받은 종목이 상승을 한다.
  - 개인 전체가 돈은 외인, 기관보다 더 많지만 공격하는데 바늘과 같이 찌르는 그런 힘이 필요하기에 외인, 기관의 수급에 영향을 많이 받는다.
  - 전쟁에서 공겨과 수비하면 보통 수비가 유리하다고 말하지만 이는 수비하고 있는곳에 공격 했을때는 말하는 것이다.
  - 하지만 공격하는 쪽에서는 수비하는쪽으로 공격하는것 처럼 꾸미고 실제 공격은 바늘과 같이 뽀족하게 한곳에 집중해 공격 하는 경우도 흔하다
  - 짧은 시간에 집중력 있게 올라간다면 돈많은개인, 세력, 기관, 외인 등을 주포라고 하는데 이들의 영향의 가능성를 염두해 둬야 한다.

* 가치투자자의 힘듬.
  - 가치가 있는것은 맞지만 표를 주는 사람이 적으면 원하는 수익을 얻을 수 없다.
  - 가치란 것은 남이 인정해 줘야 진정한 가치가 있는 것이다.

* 세력(주포)이라 불리는 사람들이 어떤 선택을 할지 고민을 많이 해야 한다.
  - 실제 돈많은 개인이 전고점 뚫으면서 수익을 챙기는 방송이 있었다. 물론 다 성공하는 것은 아니며 이들도 손절을 한다.
  - 상한가(현재 30%)의 경우 유지하고 올리는데 들어가는 비용이 많이 들어 그 뒤로 10% 정도는 더 올려야 수익이 된다는 말이 있다.
...
* 전세계의 돈이 미국으로 몰리고 전세계 1등 기업이 많아 계속 오르고 있지만 정말 무서울 수 있는 곳이다.
  ...
  - 실제로 올해 2025년 2월 교육 받을때 아침에 일어나 보니 주식이 하나도 없더라는 것이다. 그래서 원인을 확인해 보니 (자동손절 기능 작동)
